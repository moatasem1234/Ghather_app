    ...
    <div class="card-body">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name"> @lang('admin/user.uname')*</label>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="password"> @lang('admin/user.pass')*</label>
            ...
            <div class="form-group {{ $errors->has('role') ? 'has-error' : '' }}">
                <label for="role"> @lang('admin/user.role')*</label>
            ...
            <div>
                <button class="btn btn-danger" type="submit" > @lang('admin/user.save')</button>
            </div>
        </form>
    </div>
</div>
